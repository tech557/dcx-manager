...
status: Partial — CI verified live (version-assign + gates real, AC-RG-3-2/3/6 PASS); branch protection + CODEOWNERS enforcement BLOCKED (AC-RG-3-1/4/5), PO applies in GitHub UI
---
