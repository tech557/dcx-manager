...
description: Guide frontend modularization, component extraction, and architectural refactor work in DCX Manager. Use this skill whenever the user mentions refactoring a component, extracting a component, splitting a large file, modularizing the frontend, reorganizing src/, or improving component boundaries. Also trigger when an agent is about to create a new React component and should first check whether a reusable one already exists.
---

<!-- Claude adapter — canonical source: agent-skills/dcx-frontend-refactor/SKILL.md -->
<!-- This file adds Claude-specific MCP and hook context. -->
<!-- To update this skill, edit agent-skills/dcx-frontend-refactor/SKILL.md and run: bash scripts/agent/sync-skills.sh -->
