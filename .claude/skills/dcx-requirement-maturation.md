...
description: Advance a requirement node through the maturity dimension — from intent-captured to behavior-defined, rules-specified, conditions-mapped, acceptance-specified, and evidence-bound — while respecting the progressive-validation matrix. Use this skill after a requirement has been intaken (dcx-requirement-intake) and confirmed by the PO, before implementation planning begins.
---

<!-- Claude adapter — canonical source: agent-skills/dcx-requirement-maturation/SKILL.md -->
<!-- This file adds Claude-specific MCP and hook context. -->
<!-- To update this skill, edit agent-skills/dcx-requirement-maturation/SKILL.md and run: bash scripts/agent/sync-skills.sh -->
