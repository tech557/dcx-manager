...
description: >
  Plan a DCX Manager implementation, design, refactor, or technical sprint from
  current evidence. Use this skill whenever the user says "plan a sprint",
  "create a sprint for", "what should we build next", "draft a plan for",
  "write a sprint file", "plan the refactor of", or asks for acceptance criteria
  for a piece of work. Also trigger when a user describes a feature or bug and
  asks what needs to change — even if they don't use the word "sprint".
---
